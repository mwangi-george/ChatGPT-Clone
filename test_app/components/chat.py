...
from test_app.components import loading_icon
from test_app.state import QA, State
...
def action_bar() -> rx.Component:
    ...
    return rx.center(
        rx.vstack(
            ...
            rx.text(
                "ChatGPT may return factually incorrect or misleading responses. Use discretion.",
                text_align="center",
                font_size=".75em",
                color=rx.color("mauve", 10),
            ),
            rx.text(
                "Made with ❤️ by George Mwangi",
                text_align="center",
                font_size=".75em",
                color=rx.color("mauve", 10),
            ),
